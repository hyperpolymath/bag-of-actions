...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/bag-of-actions/security/advisories/new)
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/bag-of-actions/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/bag-of-actions/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/bag-of-actions/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/bag-of-actions/discussions) |
...
*Thank you for helping keep Bag Of Actions and its users safe.* 🛡️
